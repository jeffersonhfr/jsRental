                ...
                <div class="dataBox row d-flex justify-content-center align-items-center h-100">
                    <div class="col-12 col-md-6">
                        ...
                        <div class="input-group date" id="">
                            <input type="date" class="form-control data-retirada-equipamento" />
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <div class="input-group date" id="">
                            <input type="date" class="form-control data-entrega-equipamento" />
                        </div>
                    </div>
                </div>
            </div> 
        ...
        <div class="row d-flex justify-content-between align-items-center listadeequipamentoscard">
            ...
            <div class="col-12 col-md-3 col-lg-2 col-xl-2">
                ...
                <div class="col-6 col-md-3 col-lg-3 col-xl-2 d-flex">
                    ...
                    <input min="1" value="1" type="number" class="form-control form-control-sm quantidade_equipamento" max="5" placeholder="1"/>
              ...
              <div class="estudiofotografico-box">
                  ...
                  <div class="dataBox row d-flex justify-content-center align-items-center h-100">
                      <div class="col-12 col-md-6">
                          ...
                          <div class="input-group date" id="">
                              <input type="date" class="form-control dataLocacaoEstudioFotografico"/>
                              <input type="hidden" class="form-control hasEstudioFotografico" value="Aluguel Estúdio Fotográfico"/>
                          </div>
                      </div>
                      <div class="col-12 col-md-6">
                          <label for="dialocacao" class="col-6 col-form-label">Período da locação</label>
                          <div class="input-group periodo">
                              <select class="form-select periodoLocacaoEstudioFotografico">
            ...
            <div class="estudiovideo-box">
                ...
                <div class="dataBox row d-flex justify-content-center align-items-center h-100">
                    <div class="col-12 col-md-6">
                        <label for="dialocacao" class="col-6 col-form-label">Data da Locação</label>
                        <div class="input-group date" id="">
                            <input type="date" class="form-control dataLocacaoEstudioVideo"/>
                              <input type="hidden" class="form-control hasEstudioVideo" value="Aluguel Estúdio de Vídeo"/>
                        </div>
                    </div>
                    <div class="col-12 col-md-6">
                        <label for="dialocacao" class="col-6 col-form-label">Período da locação</label>
                        <div class="input-group periodo" id="">
                            <select class="form-select periodoLocacaoEstudioVideo" aria-label="">
                                <option value="Diária completa">Diária completa - 9h00 as 17h00</option>
                                <option value="Meia diária - Manhã">Meia diária - Manhã (09h00 as 12h00)</option>
                                <option value="Meia diária - Tarde">Meia diária - Tarde (13h00 as 17h00)</option>
                            </select>
                ...
                <div class="dataBox row d-flex justify-content-center align-items-center h-100">
                    <div class="col-12">
                        ...
                        <div class="input-group date" id="">
                            <select class="form-select tipoVideoInput" aria-label="">
